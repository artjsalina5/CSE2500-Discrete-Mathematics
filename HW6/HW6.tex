...
\begin{theo}
	...
	\begin{proof}
		...
		\textbf{Case I} (adding a $f$ to both sides.)\\
		\begin{align*}
			(e + f)         & < 2f \rightarrow \text{Dividing by Two}, \\
			\frac{e + f}{2} & < 2
		\end{align*}
		\textbf{Case II} (adding an $e$ to both sides.)\\
		\begin{align*}
...
\end{theo}
\begin{theo}[Unique Factorization of Integers Theorem.]
	...
	\[
		n = p^{e_1}_1p^{e_2}_2p^{e_3}_3\cdots p^{e_k}_k
	\]
...
Given any integer $n > 3$, could $n$, $n + 2$, and $n + 4$ all be prime? Prove or give a counterexample.\\
They cannot all be prime
\begin{theo}
	...
	\begin{proof}[Disproof by Counterexample]
		...
		\begin{align}
			q & > 1                                        \quad \text{or} \\
			q & = 1 \text{\quad and \quad} n = 4 = 3q + 1  \quad \text{or} \\
			q & = 1 \text{\quad and \quad} n = 5 = 3q + 2
		\end{align}
		\noindent \textbf{Case I} ($q > 1$ and $n = 3q$)\\
		$n$ is not prime because it is a product of $3$ and $q$, and both $3$ and $q$ are greater than 1.\\
		\noindent \textbf{Case II} ($q \geq 1$ and $n = 3q + 1$)\\
		\begin{align*}
			n + 2 & = (3q + 1) + 2 & \text{(By substitution)} \\
			      & = 3q + 3                                  \\
			      & = 3(q + 1)     & \text{(By algebra)}
		\end{align*}
		So $n + 2$ is not prime because it is a product of $3$ and $q + 1$, and both $3$ and $q + 1$ are greater than 1.\\

		\noindent \textbf{Case III} ($q \geq 1$ and $n = 3q + 2$)\\
		\begin{align*}
			n + 4 & = (3q + 2) + 4 & \text{(By substitution)} \\
			      & = 3q + 6                                  \\
			      & = 3(q + 2)     & \text{(By algebra)}
		\end{align*}
		So $n + 4$ is not prime because it is a product of $3$ and $q + 2$, and both $3$ and $q + 2$ are greater than 1.\\

		\noindent \textbf{Conclusion:} In all three cases, at least one of $n$, $n + 2$, or $n + 4$ is not prime.
	\end{proof}
\end{theo}
