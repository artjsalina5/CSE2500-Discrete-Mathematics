...
\begin{theo}[Induction Proof 1]
	...
	\begin{proof}[Proof by Mathematical Induction.]
		...
		\[
			\quad \frac{1}{1 \cdot 2} + \frac{1}{2 \cdot 3} + \cdots + \frac{1}{n(n+1)} = \frac{n}{n+1}
		\]
		...
		\[
			\begin{array}{c@{\quad\quad}c}
				...
				\rotatebox{90}{$=$}                                                           & \rotatebox{90}{$=$}                                    \\
				\frac{k}{k+1} + \frac{1}{(k+1)((k+1)+1)}                                      & \frac{k+1}{k+2}                                        \\
				...
				\frac{(k+1)^2}{(k+1)(k+2)}                                                    &                                                        \\
				\rotatebox{90}{$=$}                                                           & \Downarrow                                             \\
				\frac{k+1}{k+2}                                                               & \kern-3em = \hphantom{\frac{k+1}{k+2}} \frac{k+1}{k+2}
			\end{array}
		\]
	...
	\begin{proof}[Proof by Mathematical Induction.]
		...
		\[
			\begin{array}{c@{\quad\quad}c}
				...
				\rotatebox{90}{$=$}                           & \Downarrow                                               \\
				\sum_{i=1}^{(k+1)} i \cdot 2^i + (k+2)2^{k+2} & (k+1) \cdot 2^{(k+3)} + 2                                \\
				\rotatebox{90}{$=$}                           & \Downarrow                                               \\
				...
				2^{k+3}(k+1) + 2                              &                                                          \\
				\rotatebox{90}{$=$}                           & \Downarrow                                               \\
				2^{k+3}(k+1) + 2                              & \kern-1.em =\hphantom{2^{k+3}(k+1) + 2} 2^{k+3}(k+1) + 2 \\
			\end{array}
		\]
